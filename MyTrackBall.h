...
public:
	...
	void TranslateMotion(int x, int y, float ratio = 1);

	void TranslateMotionX(int x, int y, float ratio = 1);

	void TranslateTo(float x, float y, float z = 0);
	...
	MyVec3f GetTotalTranslation() const;
