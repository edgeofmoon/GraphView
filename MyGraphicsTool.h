...
public:
	...
	static void RegisterMouseWheelFunction(void(*mouseWheelFunc)(int, int, int, int));
	...
	static void SpecifyTextureImage2D(int width, int height, const void* data = 0);
...
protected:
	...
	static void (*mMouseWheelFunc)(int, int, int, int);
