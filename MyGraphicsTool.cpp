...
void (*MyGraphicsTool::mMouseWheelFunc)(int, int, int, int) = 0;
...
void MyGraphicsTool::RegisterMouseWheelFunction(void(*mouseWheelFunc)(int, int, int, int)){
	mMouseWheelFunc = mouseWheelFunc;
...
bool MyGraphicsTool::IsShiftActive(){
	return glutGetModifiers() & GLUT_ACTIVE_SHIFT;
}
bool MyGraphicsTool::IsCtrlActive(){
	return glutGetModifiers() & GLUT_ACTIVE_CTRL;
}
bool MyGraphicsTool::IsAltActive(){
	return glutGetModifiers() & GLUT_ACTIVE_ALT;
}

int MyGraphicsTool::GetModifers(){
...
void MyGraphicsTool::SpecifyTextureImage2D(int width, int height, const void* data){
