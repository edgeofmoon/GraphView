...
MyVec3f MyBoundingBox::GetBottomCenter() const{
	MyVec3f center = this->GetCenter();
	return MyVec3f(center[0], mLowPos[1], center[2]);
}

MyVec3f MyBoundingBox::GetTopCenter() const{
	MyVec3f center = this->GetCenter();
	return MyVec3f(center[0], mHighPos[1], center[2]);
}
